...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void RuntimeUtilities_BlitFullscreenTriangle_m9D27B4CEAF1DB4DB26590FD4E8012422D564099C (CommandBuffer_tB56007DC84EF56296C325EC32DD12AC1E3DC91F7* ___cmd0, RenderTargetIdentifier_tA528663AC6EB3911D8E91AA40F7070FA5455442B ___source1, RenderTargetIdentifier_tA528663AC6EB3911D8E91AA40F7070FA5455442B ___destination2, PropertySheet_tBA80DF63DC9A09D98B5F30A781448F77410D4397* ___propertySheet3, int32_t ___pass4, bool ___clear5, Nullable_1_t13F9968C978BAF968F02BA5B41ABB481321A5440 ___viewport6, const RuntimeMethod* method) ;
...
IL_0171_1:
			...
			}
			{
				...
				bool L_49;
				L_49 = TextureFormatUtilities_IsObsolete_m7F982EEAB23550BC1C661F9498072043C17A2B15(L_48, NULL);
				if (L_49)
				{
					goto IL_01a6_1;
				}
			}
			{
				...
				bool L_51;
				L_51 = SystemInfo_SupportsRenderTextureFormat_mFF17D2CC50B98C7859CE0536524C612965ACF763(((*(int32_t*)((int32_t*)(int32_t*)UnBox(L_50, RenderTextureFormat_tB6F1ED5040395B46880CE00312D2FDDBF9EEB40F_il2cpp_TypeInfo_var)))), NULL);
				V_2 = L_51;
...
IL_01c1:
	{
		...
		il2cpp_codegen_runtime_class_init_inline(Enum_t2A1A94B24E3B776EEF4E5E485E290BB9D4D072E2_il2cpp_TypeInfo_var);
		RuntimeArray* L_60;
		L_60 = Enum_GetValues_mE24D2214E046914DA4CAFB6D1DA830B76C501293(L_59, NULL);
		// foreach (var format in values)
		NullCheck(L_60);
		RuntimeObject* L_61;
...
IL_01e2_1:
			...
			}
			{
				...
				bool L_69;
				L_69 = TextureFormatUtilities_IsObsolete_m7F982EEAB23550BC1C661F9498072043C17A2B15(L_68, NULL);
				if (L_69)
				{
					goto IL_021e_1;
				}
			}
			{
				...
				bool L_71;
				L_71 = SystemInfo_SupportsTextureFormat_mB0695AD83D5244AFA9D65520E13FBC54F438A43D(((*(int32_t*)((int32_t*)(int32_t*)UnBox(L_70, TextureFormat_t87A73E4A3850D3410DC211676FC14B94226C1C1D_il2cpp_TypeInfo_var)))), NULL);
				V_5 = L_71;
...
IL_016e:
	{
		...
		il2cpp_codegen_runtime_class_init_inline(RuntimeUtilities_t275B86E9EF6FD2FCA0688D1C65BCE9BEC09BCBB6_il2cpp_TypeInfo_var);
		RuntimeUtilities_BlitFullscreenTriangle_m9D27B4CEAF1DB4DB26590FD4E8012422D564099C(L_94, L_96, L_98, L_99, 0, (bool)0, L_100, NULL);
		// return rt;
...
IL_0157:
	{
		...
		il2cpp_codegen_runtime_class_init_inline(RuntimeUtilities_t275B86E9EF6FD2FCA0688D1C65BCE9BEC09BCBB6_il2cpp_TypeInfo_var);
		RuntimeUtilities_BlitFullscreenTriangle_m9D27B4CEAF1DB4DB26590FD4E8012422D564099C(L_96, L_98, L_100, L_101, 1, (bool)0, L_102, NULL);
		// return rt;
